...
import com.overworldlabs.plots.flag.types.IntegerFlag;
import com.overworldlabs.plots.flag.types.StringFlag;
import com.overworldlabs.plots.flag.types.WeatherAssetFlag;
...
public class PlotFlagCommand extends CommandBase {
    ...
    public PlotFlagCommand(@Nonnull IPlotManager plotManager) {
        ...
        this.actionArg = CommandArgs.required(this, "action", "set, remove, or list", ArgTypes.STRING);
