 ...
 */
public class PlotUntrustCommand extends CommandBase {
    private final IPlotManager plotManager;
    private final RequiredArg<String> playerArg;

    public PlotUntrustCommand(@Nonnull IPlotManager plotManager) {
    ...
    protected void executeSync(@Nonnull CommandContext context) {
        ...
        currentWorld.execute(() -> {
            ...
            if (targetPlayerName == null) {
                CommandFeedbackService.sendUsage(playerRef, tm, "trust.usage_untrust");
                return;
            }
