package dev.stoshe.plots.api.impl;
import com.hypixel.hytale.server.core.command.system.CommandSender;

import dev.stoshe.plots.api.*;
import dev.stoshe.plots.api.events.*;
...
public class PlotsAPIImpl implements PlotsAPI {
    ...
    public Plot getPlotAt(int x, int z) {
        return plotManager.getPlotAt(plotManager.getConfig().getDefaultWorldName(), x, z);
    }

    @Override
    @Nullable
    public Plot getPlotByGrid(int gridX, int gridZ) {
        return plotManager.getPlot(plotManager.getConfig().getDefaultWorldName(), gridX, gridZ);
    }
    ...
    public String getPlotWorldName() {
        return plotManager.getConfig().getDefaultWorldName();
    }
    ...
    public boolean isPlotClaimed(int gridX, int gridZ) {
        return plotManager.getPlot(plotManager.getConfig().getDefaultWorldName(), gridX, gridZ) != null;
    }
