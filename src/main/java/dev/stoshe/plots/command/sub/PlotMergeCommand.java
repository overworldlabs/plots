...
public class PlotMergeCommand extends CommandBase {
    ...
    public PlotMergeCommand(@Nonnull IPlotManager plotManager) {
        ...
        this.removeRoadsArg = CommandArgs.optional(this, "removeRoads", "true|false",
                dev.stoshe.plots.command.SuggestingStringArgumentType.of("removeRoads", "true|false", "true", "false"));
